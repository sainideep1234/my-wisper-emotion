  ...
  const faqItems: FaqItem[] = [
    ...
    },
    {
      ...
      steps: [
        ...
        'Copy and run this command: xattr -cr "/Applications/Wisper Emotion.app"',
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div className="w-full">
              ...
              <div className="bg-[#09090b] border border-zinc-800 rounded-lg p-3 font-mono text-[11px] text-zinc-300 flex items-center justify-between gap-3 select-all">
                <span className="overflow-x-auto whitespace-nowrap scrollbar-thin">xattr -cr "/Applications/Wisper Emotion.app"</span>
                <span className="text-[10px] bg-zinc-800 hover:bg-zinc-700 text-zinc-300 px-2 py-0.5 rounded cursor-pointer transition-colors" onClick={() => navigator.clipboard.writeText('xattr -cr "/Applications/Wisper Emotion.app"')}>Copy</span>
              </div>
            </div>
          </div>
        </div>
